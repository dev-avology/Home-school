                ...
                <Row>
                    <Col xl={12} lg={12}>
                        ...
                        <Row className="project_info" justify="between">
                            <Col lg={6} xs={7}>
                                <Paragraph className="fs-14 lh-25 mb-10 mt-40 fw-400"color="#101729">Lisa R English </Paragraph>
                                <Paragraph className="fs-14 lh-25 mb-10 mt-40 fw-400 ml-20"color="#848484">December 5, 2022</Paragraph>
                            </Col>
                            <Col lg={6} xs={5}>
                                <Paragraph className="fs-14 lh-25 mb-10 mt-40 fw-400"color="#101729" textAlign="right"> Reading Time: 7 minutes</Paragraph>
                            </Col>
                        </Row>
